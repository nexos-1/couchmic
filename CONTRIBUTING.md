...
- Try it end to end: run `target\release\couchmic.exe --no-switch --port 8391 --rtc-port 8392`
...
- **Scope:** CouchMic does one thing (iPad microphone into a Windows microphone). Features that
